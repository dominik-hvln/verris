    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      <header className="flex items-center justify-between gap-4">
        <div>
          ...
          {/* FAK-01 — faktury VAT z programu księgowego. */}
          <Link
            href="/invoices/czeka-na-fakture"
            className="ml-2 mt-3 inline-flex items-center gap-2 rounded-md border border-amber-500/40 bg-amber-500/10 px-3 py-1.5 text-sm text-amber-200 hover:bg-amber-500/20"
          >
            <FileText className="h-4 w-4" />
            Czeka na fakturę VAT
          </Link>
        </div>
        {data ? (
          <a
