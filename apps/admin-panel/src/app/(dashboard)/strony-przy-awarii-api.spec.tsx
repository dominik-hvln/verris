...
/**
 * X-05 — każda strona panelu admina przy 403 i przy awarii API renderuje się (komunikat na stronie),
...
describe.each([
  ["403", () => new (AdminApiError as unknown as new (m: string, s: number) => Error)("Forbidden", 403)],
  ["awaria API", () => new Error("ECONNREFUSED")],
])("strony admina przy: %s", (_, blad) => {
  beforeEach(() => {
    api.mockReset();
