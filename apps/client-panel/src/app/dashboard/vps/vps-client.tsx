            ...
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <p className="font-semibold text-white break-words">{v.name}</p>
        ...
        <div className="space-y-1.5">
          {keys.map((k) => (
            <div key={k.id} className="flex items-center justify-between gap-2 rounded-lg border border-white/10 bg-black/20 px-3 py-2">
              <div className="min-w-0">
                <p className="text-sm text-white break-words">{k.name}</p>
                <p className="text-[11px] font-mono text-neutral-500 break-words">{k.fingerprint}</p>
              </div>
              <button
                type="button"
                onClick={() => del(k.id)}
