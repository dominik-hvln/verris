...
/** Wysokość wordmarku w krzywych ≈ wysokość liter napisu w dawnych rozmiarach tekstu. */
  ...
  return (
    ...
    >
      ...
      >
        ...
        <VerrisWordmark className={cx("shrink-0 text-verris-paper", wordSize[size])} />
      </span>
      {showTagline ? (
