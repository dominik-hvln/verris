...
export const metadata: Metadata = {
  title: 'Cennik hostingu — 39 zł/mies lub 349 zł/rok brutto | Verris',
  description:
    'Jeden pakiet hostingu z autoskalowaniem: 39 zł/mies lub 349 zł/rok brutto. Baza 50 GB NVMe, 8 GB RAM, 2 vCPU — skalowanie do 1000 GB, 64 GB, 24 vCPU. Bez limitu stron i skrzynek, SSL i migracja w cenie.',
