  ...
  return (
    <html lang="pl">
      <head>
        ...
        {/* eslint-disable-next-line @next/next/no-page-custom-font -- to root layout App Routera, więc font ładuje się na każdej stronie; reguła celuje w pages/_document */}
        <link
