...
const ODMOWA_OCZEKIWANA: ReadonlyArray<string> = [
  ...
  'DELETE /users/iam/memberships/:id',
  'GET /users/iam/invites/info',
  'PATCH /users/iam/memberships/:id',
  'POST /users/iam/invites/accept-existing',
  'DELETE /me/partner',
  'DELETE /reseller/me/clients/:clientId',
  'DELETE /reseller/me/logo',
  'GET /reseller/me/clients/:clientId',
  'POST /reseller/me/brand',
  'POST /reseller/me/clients/:clientId/password-link',
  'POST /reseller/me/clients/:clientId/service/:serviceId/resume',
  'POST /reseller/me/clients/:clientId/service/:serviceId/suspend',
  'POST /reseller/me/logo',
  ...
  'GET /agent/tasks/image-optimize/script',
  ...
  'POST /agent/nodes/bootstrap/secrets',
  ...
  'POST /agent/tasks/onboard-report',
