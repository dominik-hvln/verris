...
export const REGULY_TRAS: Regula[] = [
  ...
  {
    pasuje: zaczyna('/me/consent', '/me/marketing-preferences', '/me/status', '/me/feature-flags', '/me/beta'),
    odczyt: BEZ_WYMOGU, zapis: BEZ_WYMOGU,
  ...
  },
  {
    pasuje: (s) =>
      ...
      zawiera(
        ...
        'hosting-ssh', 'hosting-site-clone', 'hosting-htaccess', 'hosting-docroot', 'hosting-file-search', 'hosting-apps', 'hosting-slow-sql', 'hosting-pgsql', 'hosting-images',
