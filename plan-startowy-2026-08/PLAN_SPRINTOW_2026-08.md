...
Domknięcie **wszystkich** luk z macierzy to **3057 h** — przy 30 h tygodniowo około **24 miesięcy pracy solo, bez jednego przychodu po drodze**. Taki plan nie jest planem startu, tylko sposobem, żeby nigdy nie wystartować.

Dlatego praca dzieli się na dwie części: **22 sprintów do startu** (959 h) oraz roadmapę po starcie (2098 h, 119 pozycji) rozpisaną na epiki kwartalne.
...
119 pozycji, 2098 h. Epiki, nie sprinty — kolejność zweryfikujemy danymi od pierwszych klientów.
...
| `E-14` | Rozliczenia: dokończenie | WYSOKI | Q1 2027 | 6 | 76 | Z-07 z macierzy: klient płacący portfelem doładowuje saldo w karencji i i tak zostaje zawieszony. Pierwszy taki przypadek to stracony klient. |
...
- **E-14 Rozliczenia: dokończenie** (76 h) — Ponowienie płatności portfelem w karencji, waluty obce z przeliczeniem VAT, proforma, dodanie karty niezależnie od zakupu, eksport CSV.
