...
Domknięcie **wszystkich** luk z macierzy to **3195 h** — przy 30 h tygodniowo około **25 miesięcy pracy solo, bez jednego przychodu po drodze**. Taki plan nie jest planem startu, tylko sposobem, żeby nigdy nie wystartować.

Dlatego praca dzieli się na dwie części: **22 sprintów do startu** (959 h) oraz roadmapę po starcie (2236 h, 137 pozycji) rozpisaną na epiki kwartalne.
...
137 pozycji, 2236 h. Epiki, nie sprinty — kolejność zweryfikujemy danymi od pierwszych klientów.
...
| `E-09` | Pokrycie testowe warstw krytycznych | WYSOKI | ciągłe | 8 | 248 | Realizowane równolegle z każdą fazą, nie jako osobny projekt. Zasada: każda naprawiona pozycja dostaje test, który najpierw czerwieni się na starym kodzie. |
...
- **E-09 Pokrycie testowe warstw krytycznych** (248 h) — Testy integracyjne API, moduł auth, klient KSeF, ścieżka backup/restore, DirectAdminService, panele frontowe.
