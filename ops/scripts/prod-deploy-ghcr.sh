...
# Obraz do migracji = świeżo pobrany obraz API z ghcr.io (Node 24 + bash + pnpm), a NIE
# node:24 z Docker Huba. 2026-09-23: trzy deploye z rzędu padły na „TLS handshake timeout”
