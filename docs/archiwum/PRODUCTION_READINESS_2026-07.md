...
> **Zastępuje go:** raport audytu z rekomendacją NO-GO. Listę CYBER-1…11 uratowano do `docs/ops/PLAN_TESTOW_CYBER.md`. UWAGA: opis KSeF w tym pliku (FA(2)/KSeF 1.0) jest nieprawdziwy — moduł generuje FA(3) i rozmawia z API v2
