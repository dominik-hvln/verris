...
> **Zastępuje go:** plan 19 sprintów w `plan-startowy-2026-08/PLAN_SPRINTOW_2026-08.md` wraz z backlogiem XLSX — definicje ukończenia są tam per zadanie, nie per sprint
...
| ✅ PC-4 | MONTH↔YEAR w jednym flow, check `diskUsageMb` przy downgrade, regulamin §6 |
| 🔜 PC-4.3 | Plan custom / negocjowany per klient (admin manual pricing) — faza 2 |
