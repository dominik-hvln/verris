...
> **Zastępuje go:** macierz 352 pozycji z dowodami plik:linia (`audyt/dane/macierz.csv`) oraz raport audytu z 2026-08-20. UWAGA: 6 otwartych znalezisk i lista danych testowych do sprzątnięcia z produkcji przeniesione do `BACKLOG_PRZED_STARTEM.md`
